    ...
    <div className=" ps-3.5">
      ...
      <div className="mt-9 me-2.5  grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="rounded-[9px]   border-[1px]">
          ...
          <p className="text-gray-400 ps-5 mt-1.5 pb-8">Activities done today</p>
        </div>
        <div className="rounded-[9px]   border-[1px]">
          <p className="flex justify-between p-6">
          in Progress <PiPlayCircleLight className="font-bold text-blue-600"/>
          </p>
          <h1 className="font-bold text-4xl text-blue-600 ps-5.5">0</h1>
       ...
       <div className="mt-9 me-5  grid grid-cols-1 sm:grid-cols-1  md:grid-cols-4 gap-3">
        <div className="rounded-[9px]   border-[1px]">
          <p className="flex justify-between p-6">
            completed hours <CiCircleChevRight className="font-bold text-green-300" />
          </p>
          <h1 className="font-bold text-4xl text-green-500 ps-5.5">0h</h1>
          <p className="text-gray-400 ps-5 mt-1.5 pb-8">Hours completed today</p>
        </div>
        <div className="rounded-[9px]   border-[1px]">
          <p className="flex justify-between p-6">
        ...
        <div className="rounded-[9px]   border-[1px]">
          <p className="flex justify-between p-6">
           Expired Items<MdOutlineDangerous  className="font-bold text-red-500" />
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          <div className="  bg-green-200 ms-4 mb-5">
           ...
           <div className=" bg-gray-600  ms-4 mb-5">
             ...
             <p className="text-4xl text-amber-500green-500 font-bold text-amber-500 text-center">0</p>
