  ...
  return (
    <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 p-4 gap-2">
          <div>
            ...
            <select
              name="Select"
              id=""
              className="border-[1px] p-2 rounded-[8px] w-full"
            >
          ...
          <div>
            <button className="w-full p-2.5 mt-6 cursor-pointer bg-black text-white rounded-2xl">
              + Add Interval
            </button>
          </div>
        </div>
      ...
      <div className="ms-6 border-[1px] rounded-[8px] me-6 p-4">
        ...
        <div className=" mt-10">
          ...
          <p className="text-center ">
            ...
            Add intervals above to skip activity log generation on specific days
            or months.
          </p>
        </div>
      </div>
      <div className="m-5   grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4  gap-4">
        <div className="border-[1px] rounded-2xl p-8 ">
          <p className="flex justify-between">
            Daily Exclusions <FaCalendarAlt className="mt-4 ms-8 text-3xl" />
          </p>
          <p className="font-bold text-2xl">0</p>
        </div>
        <div className="border-[1px] rounded-2xl p-8  ">
          <p className="flex justify-between">
            Total Excluded Intervals <CiFilter className="mt-4 ms-8 text-3xl" />
          </p>
      ...
      <div className="m-6 p-4 border-[1px] rounded-[8px]">
        ...
        <p className="ps-3">
          Excluded intervals allow you to specify when activity logs should not
        ...
        <div className="  grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
          <div className=" mt-3 ps-3">
            ...
            <p>
              Skip activity log generation on specific days of the week (e.g.,
              weekends).
            </p>
          </div>
          <div className=" mt-3 ps-3">
            ...
            <p>
              Skip activity log generation during specific weeks of the year
              (1-52).
            </p>
          </div>
          <div className=" mt-3 ps-3">
            <h3 className="font-bold">Monthly Exclusions</h3>
            <p>
